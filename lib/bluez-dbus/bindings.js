...
NobleBindings.prototype.connect = function (deviceUuid, parameters) {
    ...
    device.bleDevice.on('connect', (e) => { this.onConnect(e, deviceUuid) });
    device.bleDevice.on('disconnect', (e) => { this.onDisconnect(e, deviceUuid) });
 ...
 * @param {string} deviceUuid BlueZ identifier of the device
 */
NobleBindings.prototype.onConnect = function (e, deviceUuid) {
 ...
 * @param {string} deviceUuid BlueZ identifier of the device
 */
NobleBindings.prototype.onDisconnect = function (e, deviceUuid) {
